...
<div class="admin-services">
    <form id="form_services" method="post" enctype="multipart/form-data">
      ...
      <div class="progress">
          <div id="progressor" class="active progress-bar progress-bar-info progress-bar-striped" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0;">
          </div>
      </div>
